...
export const mockEstudos: Content[] = [
  {
    ...
    progress: 0,
    content: `# João 3:16 - O Amor de Deus
...
*Para aprofundamento, leia todo o capítulo 3 de João e reflita sobre o diálogo completo entre Jesus e Nicodemos.*`
  },
  {
    ...
    progress: 100,
    content: `# Salmo 23 - O Senhor é Meu Pastor
...
*"Senhor, Tu és meu pastor. Ajuda-me a confiar completamente em Teu cuidado. Nos momentos de abundância, que eu reconheça Tua bondade. Nos vales escuros, que eu sinta Tua presença. Obrigado porque Tua bondade e misericórdia me seguem todos os dias. Amém."*`
  },
  {
    ...
    progress: 50,
    content: `# Liderança Servidora - O Exemplo de Jesus
...
export const mockPregacoes: Content[] = [
  {
    id: "fe-que-move-montanhas",
    title: "Fé que Move Montanhas",
    description: "Como desenvolver uma fé inabalável em Deus",
    category: "pregacoes",
    author: "Pastor Carlos Mendes",
    date: "2024-01-20",
    tags: ["fé", "milagres", "confiança"],
    progress: 0,
    content: `# Fé que Move Montanhas
...
- Confiaram em experiências passadas, não em Deus
...
**Pergunta:** O que Deus está pedindo que você faça enquanto espera o milagre?
...
Jesus disse: "direis a este monte". Não fale sobre sua montanha; fale COM ela!
...
export const mockDevocionais: Content[] = [
  {
    id: "devocional-2024-01-21",
    title: "Confiança em Meio à Tempestade",
    description: "Devocional do dia 21 de Janeiro de 2024",
    category: "devocional",
    author: "Equipe Palavra Viva",
    date: "2024-01-21",
    tags: ["confiança", "paz", "tempestade"],
    progress: 0,
    content: `# Confiança em Meio à Tempestade
